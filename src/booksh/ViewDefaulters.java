 ...
 * @author shadman
 */
public class ViewDefaulters extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tbl_booklist.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"user1", "Book_a", "20/02/23", "50 /-"},
                {"user1", "Book_b", "12/03/22", "50 /-"}
            },
            new String [] {
                "Name", "BookName", "DueDate", "Fined"
            }
        ) {
        ...
        tbl_booklist.setColorBackgoundHead(new java.awt.Color(251, 102, 102));
        tbl_booklist.setColorBordeFilas(new java.awt.Color(251, 102, 102));
